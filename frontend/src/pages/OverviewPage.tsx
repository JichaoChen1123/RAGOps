  ...
  return (
    <>
      <PageIntro
        ...
        actions={<><button className="button button-secondary" type="button"><RefreshCw size={15} />刷新数据</button><Link className="button button-primary" to={`/projects/${projectId}/evaluations`}><Play size={15} />新建评测</Link></>}
      />
      ...
      {data.metrics.length === 0 ? (
        ...
        <>
          ...
          <div className="dashboard-grid">
            <Panel title="质量趋势" eyebrow="最近 7 次评测" action={<button className="text-button" type="button">查看趋势看板 <ArrowRight size={14} /></button>} className="panel-wide">
